...
public class MapDetailsDialog {
    ...
    public MapDetailsDialog(Context mContext, String locationId, int visitCount) {
    ...
    public void showDialog(Dialog dialog){
        ...
        txtVisits = dialog.findViewById(R.id.txtVisits);
    ...
    public void getDetails(String locationId) {
        ...
        txtVisits.setText("Total visits this month: " + Integer.toString(visitCount));
    }
